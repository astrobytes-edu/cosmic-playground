...
- `:focus-visible` treatment, skip-link correctness, dialog semantics, live regions, and reduced-motion.
- Demo-specific: control labels, focus order, and `aria-*` naming for the instrument root.
