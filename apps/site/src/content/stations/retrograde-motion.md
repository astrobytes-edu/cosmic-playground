...
> **Demo setup:** Select **Earth → Mars** as the observer/target pair. Set speed to a comfortable value and press **Play**.
...
1. Select **Earth → Mars**. Press **Play** and let the animation run until you see the apparent longitude reverse direction (the longitude plot curves backward). Pause at the **first stationary point** (where the curve flattens before reversing).

2. Click **Add Row** in Station Mode. Record the date, $\lambda_\text{app}$, and motion state. Label this row **"Mars: start retrograde."**

3. Continue playing until the longitude resumes prograde motion (the second stationary point). Add another row: **"Mars: end retrograde."** The difference in dates is the retrograde duration.

4. Find the midpoint of the retrograde arc — this is close to **opposition** (Sun–Earth–Mars alignment). Add a row: **"Mars: opposition."**

5. Now switch to **Earth → Venus**. Repeat steps 1–4, recording the **start**, **end**, and **inferior conjunction** midpoint. Venus retrogrades near inferior conjunction (Sun–Venus–Earth alignment).

6. Compare your two tables: Which planet has a longer retrograde duration? Which has a larger retrograde arc?

### Data table: Mars

| Event | Date | $\lambda_\text{app}$ (deg) | Motion state | Notes |
|---|---|---|---|---|
