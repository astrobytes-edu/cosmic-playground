...
play_steps:
  ...
  - "Use the divergence readout to find where non-relativistic error exceeds 5%."
  - "Open the Sound vs Light callout and explain why observer-side crest spacing is uniform for light."
  - "Run one Mystery Spectrum round: predict -> check -> explain your evidence."
...
model_notes:
  ...
  - "Wave diagram shows uniform observer-side crest spacing at lambda_obs; this is intentional misconception resistance against sound-style ripple intuition."
