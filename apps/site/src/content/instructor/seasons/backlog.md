...
| P1 | Medium | Medium | Physics | Replace distance toy model with a simple Kepler-solver (mean anomaly $\rightarrow$ eccentric anomaly $\rightarrow$ true anomaly) for $r(t)$. | `packages/physics/src/seasonsModel.ts` |
