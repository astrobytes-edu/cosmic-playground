...
| P1 | High | Medium | Pedagogy | Add an “insolation proxy” readout (relative daily energy) built from day length $\\times$ cos(zenith angle). | `demos/seasons/seasons.js` |
...
| P1 | Medium | Low | UX | Add a “Compare hemispheres” toggle that pins both $40^\\circ$N and $40^\\circ$S readouts simultaneously. | `demos/seasons/seasons.js` |
