...
> **Clicker 1: If distance caused seasons…**
...
>
> **Demo setup:** Use defaults $\rightarrow$ click **June Solstice** and **December Solstice**; point to the North/South season labels and the Earth–Sun distance readout.
...
>
> **Demo setup:** Set **Axial Tilt = $0^\circ$** $\rightarrow$ click through the four season presets and watch day length/noon altitude stop changing.
...
>
> **Demo setup:** Set latitude to **$40^\circ$N** $\rightarrow$ click **March equinox** and **June solstice** and compare the Sun Altitude readout.

## Short answer

> **Short answer 1: Opposite hemispheres**
...
> **Short answer 2: A quick calculation (noon altitude)**
...
> **Exit ticket: The seasons sentence**
